// Anonymized role and process overview. Visuals are independent conceptual reconstructions.
export const edtechCase = {
  ...
  "sections": [
      ...
      "questionEvidence": [
        {
          ...
          "reducedUncertainty": "I mapped recurring learning needs and market patterns to separate meaningful problems from short-lived AI trends."
        },
        {
          "stage": "DEMAND",
          "question": "Do students care enough to act?",
          "reducedUncertainty": "I tested early concepts with prospective users and moved ideas forward only when the demand signal was clear."
        },
        {
          "stage": "AI VALUE",
          "question": "Does AI improve the experience?",
    ...
    },
    {
      ...
      "lessonCards": [
        {
          "title": "Validation continues after launch",
          "body": "Early testing reduced uncertainty, but real behavior revealed where the value held and where the experience still needed to change."
        },
        {
